...
```{r}
mlb_ttest = t.test(mlb$salary ~ mlb$NYYorOther, alternative= "greater")
mlb_ttest
```
...
decisionss <- ifelse(pval_l <= alpha, "reject the null hypothesis", "don't reject the null hypothesis")
```
